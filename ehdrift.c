  ...
  */
  ...
  if (setup.write_WP) return 0;
    ...
    if (write_densities) {
        ...
        // Construct file paths for electron and hole density data
        sprintf(fn_1, "%s/ed000.dat", base_dir); // Electron density file
        sprintf(fn_2, "%s/hd000.dat", base_dir); // Hole density file
